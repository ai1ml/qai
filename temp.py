...
# A. The hardcoded set of FACTS (The absolute safest, minimalist structure)
CUSTOMER_FACTS = """
Client First Name is Alex.
Client Last Name is Johnson.
ID Value is ORD-98765-XYZ.
...
"""
# --- NOTE: For testing purposes, only the above core facts are needed. ---
...
custom_tests = [
    # Test 1: Capture + Substitution Test 
    ("I need to track my order 111-222-333. How much was my refund?", 
     "The refund amount is $49.99 for order 111-222-333."), 
